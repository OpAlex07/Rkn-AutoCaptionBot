...
class Rkn_Bots(object):
    ...
    API_ID = os.environ.get("API_ID", "22652940")
    API_HASH = os.environ.get("API_HASH", "91ec0cf5f722101c98fef8f0c6aedd0e")
    ...
    # admin id  ( required.. 😥)
    ADMIN = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '1679112664').split()]
